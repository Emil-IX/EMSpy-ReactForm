...
export const EMSpyFrom = () => {
  ...
  return (
    ...
    <div className='principal principal container col-xs-12 col-sm-9'> 
        ...
        <div className='EMSform container-sm  border border-5 animate__animated animate__fadeIn'>
            ...
            { 
                ...
                <div className='d-flex'>
                    <button type='submit' className='btn btn-info btn2'>Send</button>
                    <button type='reset' onClick={ onResetForm } className='btn btn-light btn2'>Reset</button>     
                </div>
            </form>
